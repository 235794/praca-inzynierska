...
# program do pobierania danych z MAST (Barbara A. Mikulski Archive for Space Telescopes)
# argumenty wywołania: 
# - TICID: numer TIC (TESS Input Catalog) gwiazdy 
# - sector: sektor obserwacyjny, z którego mają być pobierane dane (opcjonalnie)
